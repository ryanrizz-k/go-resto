...
import (
	...
	model "github.com/rynr00/go-resto/internal/model"
)
...
// GeneratedUserHash mocks base method.
func (m *MockUserRepository) GeneratedUserHash(ctx context.Context, password string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GeneratedUserHash", ctx, password)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GeneratedUserHash indicates an expected call of GeneratedUserHash.
func (mr *MockUserRepositoryMockRecorder) GeneratedUserHash(ctx, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GeneratedUserHash", reflect.TypeOf((*MockUserRepository)(nil).GeneratedUserHash), ctx, password)
}
